System.register(["yaee", "node-int64"], function (_export) {
  /*
  ...
  var EventEmitter, Int64, AbstractParser;
  ...
  return {
    ...
    execute: function () {
      ...
      AbstractParser = (function (_EventEmitter) {
      ...
      _export("AbstractParser", AbstractParser);
    }
  };
});